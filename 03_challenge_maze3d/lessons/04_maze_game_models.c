...
int main(void)
{
    ...
    // Define our camera
    Camera camera;
    camera.position = (Vector3){ 1.0f, 1.3f, 1.0f };
    ...
    Vector3 position = Vector3Zero();   // Quad position on screen
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        else if (IsKeyDown(GLFW_KEY_UP)) position.z -= 5;
        else if (IsKeyDown(GLFW_KEY_DOWN)) position.z += 5;
        //----------------------------------------------------------------------------------
